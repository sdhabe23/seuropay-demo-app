...
export function EnterAmount(): React.ReactNode {
  ...
  const handleContinue = () => {
    if (parseFloat(amount) > 0) {
      navigate("/select-recipient", { state: { amount } });
    }
  };
    ...
    <div className="h-full bg-[#10192B] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-between p-6 overflow-hidden">
        <div className="flex flex-col items-center justify-center flex-1 mb-8">
          <p className="text-[#A3B1CC] mb-2">Enter Amount</p>
        ...
        {/* Numpad */}
        <div className="bg-[#181F32] rounded-3xl shadow-xl p-6 max-w-md mx-auto w-full">
